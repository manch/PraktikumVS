...
/**
 * 
 * @author Peter, 14. 10. 11 Klasse organisiert den Zugriff auf die Java-API
 *         für UDP. Über die Schnittstelle zur Anwendung werden die
 *         Dateneinheiten des Anwendungsprotokolls als Bytefelder angenommen und
 *         zurückgegeben. Über die Schnittstelle zum Transportprotokoll UDP
 *         werden Datagramme gesendet und empfangen. Es kann zu einer Zeit nur
 *         eine Request-Response-Beziehung verwaltet werden.
 */
public class UdpConnection {
	...
	public UdpConnection(InetSocketAddress server) // Konstruktor ClientSocket
			throws SocketException, IOException {
